...
HD_PWD='C:/Users/hp/Desktop/AES_Project/AES_Vivado/AES_Vivado.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AES_Encryption.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AES_Encryption.tcl -notrace
